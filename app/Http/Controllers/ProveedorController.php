...
class ProveedorController extends Controller
{
    ...
    public function selectProveedores(Request $request){
        if (!$request->ajax()) return redirect('/');
    ...
    public function store(Request $request)
    {
        ...
        $request->validate([
            ...
            'num_documento' => 'required|numeric|unique:personas',
    ...
    public function update(Request $request)
    {
        ...
        $request->validate([
            //REGLAS DE VALIDACIO
            'num_documento' => ['required', 'numeric', Rule::unique('personas')->ignore($_id)],
            'email' => ['required', 'string', 'email', Rule::unique('personas')->ignore($_id)],
        ]);
        try{
            DB::beginTransaction();
