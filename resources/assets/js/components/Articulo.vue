            ...
            <div class="modal-dialog modal-primary modal-lg" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="button" v-if="tipoAccion==1" class="btn btn-primary" @click="registrarArticulo()">
                            Guardar
                        </button>
        ...
        methods: {
            ...
            registrarArticulo() {
                ...
                axios.post('/articulo/registrar', {
                    ...
                    console.log(error);
                    alert('El código del artículo ya es en uso');
                });
            },
            actualizarArticulo() {
                if (this.validarArticulo()) {
            ...
            validarArticulo() {
                ...
                if (!this.stock || this.stock<0) this.errorMostrarMsjArticulo.push("El stock del artículo debe ser un número mayor a 0 y no puede estar vacío.");
                if (!this.precio_venta || this.precio_venta<0) this.errorMostrarMsjArticulo.push("El precio venta del artículo debe ser un número mayor a 0 y no puede estar vacío.");
