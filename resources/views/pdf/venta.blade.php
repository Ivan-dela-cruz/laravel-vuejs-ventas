...
@foreach ($venta as $v)
    <header>
        <div id="logo">
            <img src="img/logoleche.png" alt="CompartiendoCodigo" id="imagen">
        </div>
        <div id="datos">
            <p id="encabezado">
                <b>Asociación de Productos de leche "Simón Rodríguez"</b>
                <br>San Aguistin del Callo - Mulaló - Cotopaxi - Ecuador
                <br>Telefono: 09817539874
                <br>Email: simonrodriguez@gmail.com
            </p>
        </div>
        <div id="fact">
